...
class Popup {
    constructor({shadowID: shadowID = false, shadowType: shadowType = "transparent", closeButton: closeButton = true, closeText: closeText = false, popupClass: popupClass = "Popup", popupCaption: popupCaption = "", customBody: customBody = false, bodyElement: bodyElement = null}) {
        let shadow;
        let popupTitle;
        let popupCloseText;
...
function getForecast(e) {
    ...
    if (validateCityText()) {
        ...
        console.dir(input);
        fetch(`https://api.apixu.com/v1/current.json?key=3188df048e8949a397b180202191902&q=${geometry}`).then(response => {
            if (response.ok) {
