...
class SnackBar {
    constructor({name: name, progressbar: progressbar = true, keepAlive: keepAlive = false, confirm: confirm = true, resolveText: resolveText = "resolve", rejectText: rejectText = "reject", message: message = "Default snackbar message"}) {
...
class StudentController {
    constructor(model, view) {
        this._model = model;
        this._view = view;
        view.on("addStudentRequest", this.constructor.addStudent, this);
        view.on("deleteStudentRequest", model.deleteStudent, model);
        model.on("studentAdded", view.addStudentToTable, view);
        model.on("studentDeleted", view.removeStudentFromTable, view);
    }
